    ...
    <form action="{{ route('gym.store') }}" method="POST">
        ...
        <div class="input-group">
            ...
            <div class="input-box">
                ...
                <input type="text" name="managerName" placeholder="Digite o nome" id="managerName" maxlength="100" required
                    value="{{ old('managerName') }}" />
                @error('managerName')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="input-box">
                ...
                <input type="tel" name="gymPhone" maxlength="11" placeholder="Digite o número" id="gymPhone" required
                    value="{{ old('gymPhone') }}" oninput="formatOnlyNumbers(this)" />
                @error('gymPhone')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="input-box">
                ...
                <input type="tel" name="managerPhone" maxlength="11" placeholder="Digite o número" id="managerPhone"
                    required value="{{ old('managerPhone') }}" oninput="formatOnlyNumbers(this)" />
                @error('managerPhone')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="input-box">
                ...
                <input type="email" name="manager_email" placeholder="Digite o email" maxlength="255" id="email" required
            ...
            <div class="input-box">
                ...
                <input type="text" id="cpf" name="manager_cpf" maxlength="11" placeholder="Digite o cpf" required
                    value="{{ old('manager_cpf') }}" oninput="formatOnlyNumbers(this)" />
                @error('manager_cpf')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="input-box">
                ...
                <select id="state" name="state" required>
                    ...
                    @foreach($states as $sigla => $nome)
                        <option value="{{ $sigla }}" {{ old('state') == $sigla ? 'selected' : '' }}>{{ $nome }}</option>
                    @endforeach
                </select>
                @error('state')
                    <span style="color: red;">{{ $message }}</span>
            ...
            <div class="input-box">
                ...
                <select id="city" name="city" required>
                    <option value="{{ old('city') }}">{{ old('city') ? old('city') : 'Selecione uma cidade' }}</option>
                </select>
                @error('city')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            ...
            <div class="input-box">
                ...
                <input type="text" name="street" placeholder="Digite o nome da rua" maxlength="100" id="street" required
                    value="{{ old('street') }}" />
                @error('street')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
            ...
            <div class="input-box">
                ...
                <input type="text" name="complement" placeholder="Digite o complemento" id="complement" maxlength="255"
