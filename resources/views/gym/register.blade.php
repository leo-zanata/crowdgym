                ...
                <form action="{{ route('gym.store') }}" method="POST">
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            ...
                            <input type="text" name="gym_name" placeholder="Digite o nome" id="gymName" maxlength="100"
                                required value="{{ old('gymName') }}" />
                            @error('gymName')
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="manager_name" placeholder="Digite o nome" id="managerName"
                                maxlength="100" required value="{{ old('managerName') }}" />
                            @error('managerName')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <input type="tel" name="gym_phone" maxlength="11" placeholder="Digite o número" id="gymPhone" required
                                value="{{ old('gymPhone') }}" />
                            @error('gymPhone')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="input-box">
                            ...
                            <input type="tel" name="manager_phone" maxlength="11" placeholder="Digite o número" id="managerPhone"
                        ...
                        <div class="input-box">
                            ...
                            <select id="city" name="city" required>
                                <option value="{{ old('city') }}">
                                    {{ old('city') ? old('city') : 'Selecione uma cidade' }}</option>
                            </select>
                            @error('city')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="neighborhood" placeholder="Digite o nome do bairro"
                                id="neighborhood" maxlength="100" required value="{{ old('neighborhood') }}" />
                            @error('neighborhood')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="street" placeholder="Digite o nome da rua" maxlength="100"
                                id="street" required value="{{ old('street') }}" />
                            @error('street')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <input type="number" name="number" placeholder="Digite o numero" maxlength="10" id="number"
