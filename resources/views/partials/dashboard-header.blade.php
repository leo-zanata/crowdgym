<header class="navbar">
    <div class="nav-header">
        ...
        <nav class="nav-buttons">
            <a href="{{ route('dashboard.member') }}" class="header-buttons">Dashboard</a>
            <a href="{{ route('gym.my') }}" class="header-buttons">Minhas Academias</a>
            <a href="{{ route('payment.data') }} " class="header-buttons">Dados de Pagamento</a>
