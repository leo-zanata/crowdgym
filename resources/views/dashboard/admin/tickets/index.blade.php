...
@section('title', 'Gerenciar Tickets de Suporte (Admin)')
                    ...
                    @forelse ($tickets as $ticket)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.tickets.show', $ticket) }}" class="text-indigo-600 hover:text-indigo-900 transition duration-150 ease-in-out">
                                    Visualizar
                                </a>
                            </td>
                        </tr>
