...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white rounded-lg shadow-xl p-8 mb-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('manager.tickets.index') }}" class="text-blue-600 hover:text-blue-800 transition duration-150 ease-in-out">
        ...
        <div class="bg-gray-100 p-6 rounded-lg mb-6">
            <div class="flex items-center space-x-4 mb-2">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode($ticket->user?->name ?? 'U') }}" alt="Avatar">
                </div>
                <div class="flex-1">
        ...
        <div class="space-y-4 mb-6">
            @forelse($ticket->replies ?? [] as $reply)
                <div class="p-4 rounded-lg {{ $reply->user_id === Auth::id() ? 'bg-indigo-100 text-indigo-900' : 'bg-gray-200 text-gray-800' }}">
        ...
        @if ($ticket->status !== 'resolved')
            <form action="{{ route('manager.tickets.reply.store', $ticket) }}" method="POST">
                @csrf
                <div>
                ...
                <div class="mt-4 flex justify-between items-center">
                    ...
                    <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                        Enviar Resposta
                    </button>
                </div>
            </form>
